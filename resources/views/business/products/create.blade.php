                    ...
                    <form method="POST" action="{{ route('business.products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="price_cash" class="block mt-1 w-full" type="number" step="0.01" name="price_cash" :value="old('price_cash', 0)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="price_points" class="block mt-1 w-full" type="number" name="price_points" :value="old('price_points', 0)" required />
