...
class ClaimController extends Controller
{
    ...
    /**
     * Display the customer's claim history.
     */
    ...
    /**
     * Display the customer's claim history filtered by category.
     */
    ...
    public function create()
    {
        ...
        if (!request()->has('category_id')) {
            return redirect()->route('customer.claims.index')->with('info', 'Please select a category first.');
        }
        ...
        if ($request->has('category_id')) {
            ...
            if ($selectedCategory && $selectedCategory->end_date && $selectedCategory->end_date->isPast()) {
                return redirect()->route('customer.claims.index')->with('error', 'This claim category has expired.');
            }
        }

        return view('customer.claims.create', compact('business', 'categories'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('customer.claims.index')->with('status', 'Claim submitted successfully!');
    }
